...
export default function Testing() {
  return (
    <div className="bg-white min-h-screen flex flex-col">
      <Helmet>
        <title>Testing - Certiva TUV</title>
      </Helmet>
      <Navbar />
      <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pt-24 w-full">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Testing</h1>
        
        <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
          <p>
            Welcome to the Testing page. This section provides detailed information about our testing services and offerings. 
